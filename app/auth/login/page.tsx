  ...
  return (
    <div className="flex min-h-svh items-center justify-center bg-white px-5">
      <div className="w-full max-w-[400px]">
        ...
        <button
          type="button"
          className="flex w-full items-center justify-center gap-3 border border-[#222] uppercase text-[#222] transition-all duration-300 hover:bg-[#222] hover:text-white"
